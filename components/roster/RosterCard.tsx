...
export function RosterCard({ sport, credential }: RosterCardProps) {
  return (
    <div className="w-[260px] flex-shrink-0">
      <div className="roster-card-inner rounded-2xl bg-white/[0.04] border border-white/[0.07] backdrop-blur-xl p-3 glass-sheen transition-all duration-300 hover:bg-white/[0.07] cursor-default">
        {/* Neutral blurred placeholder */}
        <div className="roster-card-image relative w-full aspect-[3/4] mb-3 rounded-xl overflow-hidden bg-white/[0.04]">
